function kmlstr = Model(file,namea,loc,ori,scale,altmode)
arguments
    file 
    namea 
    loc 
...
kmlstr = [kmlstr; sprintf("<name>%s</name>",namea)];

kmlstr = [kmlstr; sprintf("<Model id=""%s"">",namea)];

kmlstr = [kmlstr; sprintf("<altitudeMode>%s</altitudeMode>",altmode)];

kmlstr = [kmlstr; sprintf("<Location id=""%sLoc"">",namea)];
...
kmlstr = [kmlstr; sprintf("<Orientation id=""%sOri"">",namea)];
